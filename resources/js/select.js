...
// Function to set Chosen translations
...
// Initialize Chosen on document ready
$(document).ready(function () {
    const userLanguage = $("html").attr("lang") || "ua";
    console.log(userLanguage);
    setChosenTranslations(userLanguage); // Set translations based on the detected language
});
