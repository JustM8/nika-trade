        ...
        <section class="catalog-single page-container">
            <div class="catalog-single-wrap">
                ...
                <div class="catalog-single-info-wrap">
                    <p class="catalog-single-info__title text-m">Діючі ціни можуть відрізнятись від вказаних на цій сторінці, уточнюйте!      </p>
            ...
            <div class="equipment-info-wrap">
                ...
                <div class="equipment-info">
                    ...
                    <div class="equipment-info__descr-wrap">
                        ...
                        <p class="equipment-info__descr text-14">В якості зразка обладнання торгових мереж «НІКА» може запропонувати варіант забудови відділів дитячих товарів в гіпермаркетах «Епіцентр К».</p>
                    </div>
                </div>
            </div>
        </div>
