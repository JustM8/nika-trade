...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="0" height="0" style="position:absolute">
		...
		<symbol id="icon-arrow-item-contacts" viewBox="0 0 14 14">
			<path d="M0 7h12m0 0L5.965 1M12 7l-6.035 6" stroke="#DD405D" stroke-width="1.5"></path>
		</symbol>
		...
		<symbol id="icon-cart-map" viewBox="0 0 12 14">
			<path fill-rule="evenodd" clip-rule="evenodd" d="M6 14s6-4.2 6-8.4c0-1.485-.632-2.91-1.757-3.96C9.117.59 7.59 0 6 0 4.409 0 2.883.59 1.757 1.64.632 2.69 0 4.115 0 5.6 0 9.8 6 14 6 14zm2-8a2 2 0 1 1-4 0 2 2 0 0 1 4 0z" fill="#DD405D"></path>
		</symbol>
...
<div class="preloader">
    <svg class="preloader__image" width="108" height="88" viewBox="0 0 108 88" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect width="108" height="88" fill="#DD405D"/>
        ...
        <div class="header-bottom">
          ...
          <div class="header-right-wrap">
            ...
            <div class="header-callback-wrap">
              <a class="header-callback" href="mailto:nika@nika-trade.net.ua" target="_blank">
